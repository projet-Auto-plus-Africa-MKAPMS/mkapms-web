...
import { ChevronLeft, Calendar, Check, Clock, X, Euro, FileText } from "lucide-react";
const RESERVATIONS = [
    ...
    <div className="min-h-screen bg-[#F5F3EF] pb-24">
      ...
      <div className="px-4 mt-4 space-y-2">{RESERVATIONS.map((r) => (
        <div key={r.id} className="rounded-xl bg-white border border-[#E5E7EB] p-4">
          ...
          <div className="mt-2 flex items-center gap-2"><Euro size={12} className="text-[#D4AF37]" /><span className="text-sm font-bold text-[#D4AF37]">Acompte: {r.acompte} €</span></div>
