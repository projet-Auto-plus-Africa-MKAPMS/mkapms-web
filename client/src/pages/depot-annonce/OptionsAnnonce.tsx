  ...
  return (
    <div className="min-h-screen bg-[#F5F3EF] pb-24">
      ...
      <div className="px-4 mt-4 space-y-2">
        ...
        <Link to="/depot-annonce/analyse-i-a" className="block w-full py-3 bg-[#D4AF37] text-white rounded-xl text-sm font-bold text-center mt-4">Continuer → Analyse Intelligence</Link>
      </div>
    </div>
  );
}
