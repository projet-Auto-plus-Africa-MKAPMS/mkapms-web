  ...
  return (
    <div className="min-h-screen bg-[#F5F3EF] pb-24">
      ...
      <div className="px-4 mt-4 space-y-2">
        ...
        <div className="rounded-xl bg-[#D4AF37]/10 border border-[#D4AF37]/30 p-3 flex items-center gap-2"><Shield size={14} className="text-[#D4AF37]" /><p className="text-[10px] text-[#374151]">Vos documents sont vérifiés par MKA.P-MS AI puis validés par un humain. Jamais de validation Intelligence seule.</p></div>
