    ...
    <div className="min-h-screen bg-[#F5F3EF] pb-24">
      ...
      <div className="mx-4 mt-4 rounded-xl bg-white border border-[#E5E7EB] p-4 space-y-3">
        <div className="grid grid-cols-2 gap-3">
          <div><label className="text-xs text-[#6B7280]">Prénom *</label><div className="mt-1 flex items-center gap-2 rounded-lg border border-[#E5E7EB] px-3 py-2.5"><User size={14} className="text-[#6B7280]" /><input type="text" placeholder="Votre prénom" className="w-full bg-transparent text-sm outline-none" /></div></div>
          <div><label className="text-xs text-[#6B7280]">Nom *</label><div className="mt-1 flex items-center gap-2 rounded-lg border border-[#E5E7EB] px-3 py-2.5"><User size={14} className="text-[#6B7280]" /><input type="text" placeholder="Votre nom" className="w-full bg-transparent text-sm outline-none" /></div></div>
        </div>
        <div><label className="text-xs text-[#6B7280]">Email *</label><div className="mt-1 flex items-center gap-2 rounded-lg border border-[#E5E7EB] px-3 py-2.5"><Mail size={14} className="text-[#6B7280]" /><input type="email" placeholder="votre@email.com" className="w-full bg-transparent text-sm outline-none" /></div></div>
