...
export default function DossiersFlottes() {
  return (
    <div className="min-h-screen bg-[#F5F3EF] pb-24">
      <div className="bg-blue-800 px-4 pt-6 pb-5"><Link to="/garage/flottes-entreprises" className="flex items-center gap-1 text-sm text-white/60 mb-2"><ChevronLeft size={14} /> Flotte</Link><h1 className="text-xl font-black text-white flex items-center gap-2"><Car size={20} /> Peugeot 3008</h1><p className="mt-1 text-sm text-white/80">AB-123-CD · 45 000 km</p></div>
