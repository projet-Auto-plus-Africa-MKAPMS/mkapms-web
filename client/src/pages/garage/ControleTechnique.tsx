...
export default function ControleTechnique() {
  return (
    <div className="min-h-screen bg-[#F5F3EF] pb-24">
      ...
      <div className="px-4 mt-4"><Link to="/garage/prise-rendez-vous" className="block w-full rounded-xl bg-green-700 py-3 text-center text-sm font-bold text-white active:scale-[0.98]">Prendre rendez-vous CT</Link></div>
