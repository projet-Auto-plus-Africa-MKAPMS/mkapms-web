...
export default function FlottesEntreprises() {
  return (
    <div className="min-h-screen bg-[#F5F3EF] pb-24">
      <div className="bg-blue-800 px-4 pt-6 pb-5"><Link to="/garage/garage-professionnel" className="flex items-center gap-1 text-sm text-white/60 mb-2"><ChevronLeft size={14} /> Garage Pro</Link><h1 className="text-xl font-black text-white flex items-center gap-2"><Truck size={20} /> Flotte entreprise</h1><p className="mt-1 text-sm text-white/80">SAS Auto+ — {VEHICULES.length} véhicules</p></div>
