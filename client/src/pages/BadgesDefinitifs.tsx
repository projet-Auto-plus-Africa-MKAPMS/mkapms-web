...
const BADGES = [
  ...
  { nom: "VÉRIFIÉ", couleur: "#10B981", bg: "bg-green-500", icon: Shield, desc: "Identité et documents vérifiés par MKA.P-MS", conditions: ["Identité vérifiée par Intelligence + humain", "Tous documents validés"] },
