  ...
  return (
    <div className="min-h-screen bg-[#F5F3EF] pb-24">
      ...
      <div className="relative overflow-hidden">
        <img src="https://images.unsplash.com/photo-1549194898-60fd030ecc0f?w=800&h=420&fit=crop" alt="Utilitaires" className="w-full h-[240px] object-cover" />
      ...
      <div className="px-4 mt-4">
        ...
        <div className="space-y-4">
          {filteredVehicules.map((v) => (
            <Link key={v.id} to={`/louer/utilitaires/vehicule/${v.id}`} className="block rounded-xl bg-white border border-[#E5E7EB] overflow-hidden active:scale-[0.99] transition">
