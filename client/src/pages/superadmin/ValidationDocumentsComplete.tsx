...
const STATUTS: Record<string, { label: string; color: string }> = {
  ...
  analyse_ia: { label: "Analyse Intelligence", color: "bg-purple-100 text-purple-700" },
  ...
  return (
    <div className="min-h-screen bg-[#F5F3EF] pb-24">
      <div className="bg-[#111] px-4 pt-6 pb-5">
        ...
        <p className="text-xs text-white/50 mt-1">Intelligence contrôle → puis validation humaine obligatoire</p>
      </div>
      <div className="px-4 -mt-3 relative z-10 rounded-xl bg-[#D4AF37]/10 border border-[#D4AF37]/30 p-3 mb-4 flex items-center gap-2">
        ...
        <p className="text-[10px] text-[#6B7280]"><span className="font-bold text-[#D4AF37]">Intelligence Obligatoire :</span> Faux documents, doublons, incohérences détectés automatiquement. Jamais de validation Intelligence seule.</p>
      </div>
