...
function getVehicleTier(v: any): VehicleTier {
  // Annonce officielle MKA.P-MS (catégorisation ou ownership ou IDs démo)
  if (v.categorieAnnonce === "officielle" || v.ownership === "plateforme" || (v.id >= 8000 && v.id <= 8005)) return "officiel";
    ...
    return (
      <div className="pb-24 md:pb-20">
        ...
        >
          ...
          {!isParticulier && (
          <a href={whatsapp} target="_blank" rel="noreferrer" onClick={(e) => e.stopPropagation()} className={`fixed right-2 flex h-8 w-8 items-center justify-center rounded-full transition-all duration-500 ${scrollHidden ? 'opacity-0 scale-50 pointer-events-none' : 'opacity-100 scale-100'}`} style={{top: '45%', zIndex: 40, backgroundColor: '#25D366', boxShadow: scrollHidden ? 'none' : '0 0 16px rgba(212,175,55,0.8), 0 0 6px rgba(37,211,102,0.9), 0 0 30px rgba(212,175,55,0.3)'}}>
    ...
    <div className="container-page py-6 pb-32 md:pb-10">
      ...
      <div className="grid gap-6 lg:grid-cols-[1.6fr_1fr] lg:items-start">
        ...
        <aside className="space-y-5 lg:col-start-2 lg:row-start-1 lg:sticky lg:top-20">
          ...
          {!isLocation && !isOfficiel && (tier === "professionnel" || (tier as string) === "premium") && (
        ...
        <section className="min-w-0 space-y-6 lg:col-start-1 lg:row-start-2">
          ...
          ) : tier === "professionnel" || (tier as string) === "premium" ? (
            /* ── VENDEUR PRO ── */
