    ...
    return (
      <div className="pb-24 md:pb-20">
        ...
        >
          ...
          {/* WhatsApp collé à droite sur la photo — toujours visible */}
          <a href={whatsapp} target="_blank" rel="noreferrer" onClick={(e) => e.stopPropagation()} className="absolute right-3 top-[55%] flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg hover:bg-green-600 transition z-10">
        ...
        {/* ===== BARRE FIXE EN BAS : Appeler + Message — AU-DESSUS nav bar */}
