    ...
    return (
      <div className="pb-24 md:pb-20">
        ...
        >
          ...
          {v.contactTelephone && (
            <a href={whatsapp} target="_blank" rel="noreferrer" onClick={(e) => e.stopPropagation()} className="absolute right-3 top-[35%] flex h-12 w-12 items-center justify-center rounded-full bg-green-500 text-white shadow-lg hover:bg-green-600 transition z-10">
