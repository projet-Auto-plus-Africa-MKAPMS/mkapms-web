    ...
    return (
      <div className="pb-24 md:pb-20">
        ...
        >
          ...
          <a href={whatsapp} target="_blank" rel="noreferrer" onClick={(e) => e.stopPropagation()} className="absolute right-4 top-[55%] flex h-14 w-14 items-center justify-center rounded-full shadow-xl" style={{backgroundColor: '#25D366', zIndex: 20}}>
