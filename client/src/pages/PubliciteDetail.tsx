...
const DEMO_DEMANDES = [
  { id: "PUB-001", entreprise: "AutoPièces Express", type: "Vendeur de pièces", emplacement: "Page produit — Carrousel #4", status: "en_attente", tel: "06 12 34 56 78", email: "contact@autopieces-express.fr", desc: "Ouverture magasin Sarcelles — pièces neuves toutes marques. Publicité image + lien vers notre site.", lien: "https://autopieces-express.fr", duree: "1 semaine", adresse: "12 Rue de la Gare, 95200 Sarcelles", siret: "123 456 789 00012", dateDepot: "05/06/2024", contact: "M. Diallo", typeContenu: "photo", photoUrl: "https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=600&h=400&fit=crop", tarif: "180€" },
