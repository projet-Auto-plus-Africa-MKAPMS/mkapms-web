...
import { ChevronLeft, Star, MapPin, ChevronDown, Heart } from "lucide-react";
        ...
        {showFilters && (
          <div className="mt-3 space-y-3">
            ...
            <div className="flex gap-2">
              ...
              <button type="button" onClick={() => { search.apply(); setShowFilters(false); }} className="flex-1 py-2.5 bg-emerald-600 text-white rounded-xl text-xs font-bold active:scale-[0.98] transition">
                Rechercher
              </button>
            </div>
          </div>
