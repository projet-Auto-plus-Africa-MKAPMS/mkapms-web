...
const UNIVERS = [
  ...
  { id: "camions-engins", label: "Engins & Machines", desc: "Chantier, TP, agricole, forestier, industriel, minier — tout ce qui roule sur terre.", photo: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&h=400&fit=crop", to: "/acheter/camions-engins", badge: "Engins & Machines", badgeColor: "bg-[#1a1a2e] text-white border-transparent", icon: HardHat },
