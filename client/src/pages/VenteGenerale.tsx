...
const UNIVERS = [
  { id: "mkapms", label: "Acheter un véhicule certifié MKA.P-MS", desc: "Véhicules MKA.P-MS : contrôle qualité, historique complet, Finance+, garantie.", photo: "/categories/cover_mkapms.jpg", to: "/acheter/mkapms-officiel", badge: "MKA.P-MS Officiel", badgeColor: "bg-[#111] text-[#D4AF37]" },
  { id: "pro", label: "Acheter un véhicule professionnel", desc: "Garages, marchands, concessionnaires. Garantie, historique, factures.", photo: "/categories/cover_pro.jpg", to: "/acheter/professionnel", badge: "Professionnel", badgeColor: "bg-blue-800 text-white" },
  { id: "particulier", label: "Acheter un véhicule", desc: "Citadines, berlines, SUV, monospaces entre particuliers et pros.", photo: "/categories/cover_particulier.jpg", to: "/acheter/particulier", badge: "Particulier", badgeColor: "bg-[#D4AF37] text-white" },
  { id: "moto", label: "Acheter une moto", desc: "Scooters, 125, routières, trail, sportives, cross.", photo: "/categories/cover_moto.jpg", to: "/acheter/moto", badge: "Moto", badgeColor: "bg-red-600 text-white" },
  { id: "utilitaires", label: "Acheter un utilitaire", desc: "Kangoo, Berlingo, Partner, Trafic, Master, Boxer.", photo: "/categories/cover_utilitaires.jpg", to: "/acheter/utilitaires", badge: "Utilitaires", badgeColor: "bg-orange-600 text-white" },
  { id: "camions", label: "Acheter un camion", desc: "Porte-voitures, bennes, frigorifiques, poids lourds.", photo: "/categories/cover_camions.jpg", to: "/acheter/camions", badge: "Camions", badgeColor: "bg-gray-700 text-white" },
  { id: "vtc", label: "Acheter un véhicule VTC / Taxi", desc: "Véhicules adaptés à l'activité VTC et Taxi avec revenus estimés.", photo: "/categories/cover_vtc_taxi.jpg", to: "/acheter/vtc-taxi", badge: "VTC & Taxi", badgeColor: "bg-[#111] text-[#D4AF37]" },
  { id: "promo", label: "Promotions & Déstockage", desc: "Offres limitées, fins de série, déstockage, prix réduits.", photo: "/categories/cover_promo.jpg", to: "/acheter/promotions", badge: "Promo", badgeColor: "bg-green-600 text-white" },
  { id: "encheres", label: "Vente aux enchères", desc: "Réservé aux professionnels validés. Lots, reprises, vente rapide.", photo: "/categories/cover_encheres.jpg", to: "/acheter/encheres", badge: "Enchères", badgeColor: "bg-purple-700 text-white" },
];
