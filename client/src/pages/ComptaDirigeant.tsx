...
const EMPLOYES: Employe[] = [
  ...
  { id: 21, nom: "Agent B.", poste: "Agent de securite", heuresM: "176h", presence: "100%", taches: 20, perf: 90, statut: "present", email: "agent.b@exemple.com", tel: "+33 6 12 23 34 45", dateEmbauche: "01/05/2024", departement: "Securite", salaire: "2 100 EUR", formation: "CQP Agent de Securite", derniereCo: "09/06/2026 18:30" },
