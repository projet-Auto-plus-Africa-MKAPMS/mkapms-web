...
export default function DeclarationCession() {
  return (
    <div className="min-h-screen bg-[#F5F3EF] pb-24">
      ...
      <div className="mx-4 mt-3 rounded-xl bg-white border border-[#E5E7EB] p-4"><h3 className="text-sm font-bold text-[#111] mb-2">Signature numérique</h3><div className="rounded-lg border-2 border-dashed border-[#E5E7EB] h-20 flex items-center justify-center text-xs text-red-500">Signer ici</div></div>
