...
export default function LOAFinance() {
  return (
    <div className="min-h-screen bg-[#F5F3EF] pb-24">
      ...
      {/* LOT IA02E — aucun moteur de calcul LOA n'existe encore côté serveur : exemple, jamais un devis. */}
      <div className="mx-4 mt-4 rounded-xl bg-amber-50 border border-amber-300 p-3"><p className="text-xs text-amber-800">Exemple à titre indicatif, non contractuel. Le calcul personnalisé n'est pas encore disponible.</p></div>
      ...
      <div className="px-4 mt-3"><button disabled title="Calcul personnalisé non disponible" className="w-full rounded-xl bg-purple-700/40 py-3 text-sm font-bold text-white/70 cursor-not-allowed">Simulation indisponible</button></div>
    </div>
  );
}
