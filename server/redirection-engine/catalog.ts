...
export const PATH_ALIASES: PathAlias[] = [
  ...
  { from: "/vente/factures", to: "/utilisateurs/factures-utilisateur", label: "Chemin — Factures vente → Mes factures" },
  { from: "/profil", to: "/compte", label: "Chemin — Profil → Mon compte" },
  { from: "/vente/tableau-de-bord", to: "/vente", label: "Chemin — Tableau de bord vente → Vente" },
];
...
export const DEFAULT_REDIRECT_RULES: DefaultRule[] = [
  ...
  { key: "demarches_carte_grise", label: "Démarches — Nouveau dossier carte grise", kind: "button", target: "/demarches/carte-grise-demarche", priority: 90 },
  { key: "demarches_suivi_dossier", label: "Démarches — Suivi d'un dossier", kind: "button", target: "/demarches/suivi-dossier", priority: 90 },
  { key: "demarches_connexion", label: "Démarches — Connexion avant dépôt", kind: "button", target: "/connexion", priority: 90 },
  { key: "demarches_ouvrir_changement_adresse", label: "Démarches — Changement d'adresse", kind: "button", target: "/demarches/changement-adresse", priority: 90 },
  { key: "demarches_ouvrir_changement_titulaire", label: "Démarches — Changement de titulaire", kind: "button", target: "/demarches/changement-titulaire", priority: 90 },
  { key: "demarches_ouvrir_declaration_cession", label: "Démarches — Déclaration de cession", kind: "button", target: "/demarches/declaration-cession", priority: 90 },
  { key: "demarches_ouvrir_duplicata_demarche", label: "Démarches — Duplicata de carte grise", kind: "button", target: "/demarches/duplicata-demarche", priority: 90 },
  { key: "demarches_ouvrir_immatriculation_provisoire", label: "Démarches — Immatriculation provisoire (WW)", kind: "button", target: "/demarches/immatriculation-provisoire", priority: 90 },
  { key: "demarches_ouvrir_importation_vehicule", label: "Démarches — Importation de véhicule", kind: "button", target: "/demarches/importation-vehicule", priority: 90 },
