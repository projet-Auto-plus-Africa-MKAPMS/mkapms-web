...
export const PERIMETRES: PerimetreDeclare[] = [
  ...
  {
    moteur: "workflow",
    dossiers: ["modules/hr-direction.ts", "modules/operations.ts", "routers/operations.ts", "routers/objectifs.ts"],
    routeurs: ["governance", "platform", "quality", "hr", "procurement", "investor", "objectifs"],
  ...
  {
    moteur: "payment",
    dossiers: ["payment-engine", "stripeWebhook.ts", "lib/stripe.ts", "lib/payment-errors.ts", "modules/wallet.ts", "modules/wallet-ledger.ts", "routers/wallet.ts", "modules/installments.ts", "routers/installments.ts", "routers/abonnements.ts", "routers/badges.ts"],
    routeurs: ["paymentEngine", "wallet", "installments", "abonnements", "badges"],
  ...
  },
  {
    ...
    dossiers: ["payout-engine"],
    routeurs: ["payoutEngine"],
    routes: [],
  },
  {
  ...
  {
    // LOT 3 du Plan Maître Fournisseurs — pièces automobiles uniquement
    // (jamais Transport/Livraison [LOT 4] ni Paiements complets [LOT 5]).
    // Pas encore d'écran dédié (LOT 7 "Portails") : routes vides, staging
    // tant qu'aucune pièce fournisseur réelle n'a été publiée de bout en bout.
    moteur: "parts_engine",
    dossiers: ["parts-engine"],
    routeurs: ["partsEngine"],
    routes: [],
  },
  {
