...
export const ENGINE_CATALOG: EngineSeed[] = [
  ...
  },
  {
    ...
    category: "transversal",
    dependencies: ["core","seo","smart","identity"],
    description:
  ...
  },
  {
    ...
    label: "Garage Engine",
    category: "univers",
    dependencies: ["core","identity","notification","payment","scheduler","seo","achat","atelier","avis_reputation","boutons","depannage","support","visibility","country"],
  ...
  },
  {
    ...
    category: "univers",
    dependencies: ["core","identity","payment","notification","seo","product_engine","avis_reputation","event_bus","payment_orchestrator"],
  ...
  },
  {
    ...
    category: "univers",
    dependencies: ["core","permission","achat","notification","payment","smart","vo_espaces","country"],
  ...
  },
  {
    ...
    category: "transversal",
    dependencies: ["core","smart","seo","event_bus"],
    description:
  ...
  },
  {
    ...
    category: "transversal",
    dependencies: ["core","smart","seo","audit"],
    description:
  ...
  },
  {
    ...
    category: "univers",
    dependencies: ["core","smart","politique_pays","country","event_bus"],
