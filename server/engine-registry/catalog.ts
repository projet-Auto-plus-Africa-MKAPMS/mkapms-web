...
export const ENGINE_CATALOG: EngineSeed[] = [
  ...
  },
  {
    ...
    label: "SEO Engine",
    category: "transversal",
    dependencies: ["core", "smart", "country", "language"],
  ...
  },
  {
    ...
    category: "transversal",
    dependencies: ["core", "identity", "notification", "permission", "scheduler"],
  ...
  },
  {
    ...
    label: "Garage Engine",
    category: "univers",
    dependencies: ["core", "identity", "notification", "payment", "scheduler", "seo"],
  ...
  },
  {
    ...
    category: "univers",
    dependencies: ["core", "identity", "payment", "notification", "seo", "product_engine"],
  ...
  },
  {
    ...
    category: "univers",
    dependencies: ["core", "identity", "notification", "payment", "scheduler", "proximity_engine"],
  ...
  },
  {
    ...
    category: "univers",
    dependencies: ["core", "identity", "document", "notification", "payment"],
