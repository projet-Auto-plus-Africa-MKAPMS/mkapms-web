...
export const SETTINGS_REGISTRY: Reglage[] = [
  ...
  { cle: "intelligence.memoire", categorie: "intelligence", libelle: "Mémoire", etat: "CENTRALIZED", source: "server/intelligences/memoire.ts", motif: "Mémoire d'entreprise (13 catégories, PDG uniquement) — distincte de intelligence.memoire_utilisateur." },
  { cle: "intelligence.memoire_utilisateur", categorie: "intelligence", libelle: "Mémoire utilisateur", etat: "CONNECTED_AND_TESTED", source: "server/intelligences/memoire-utilisateur.ts (LOT IA02F)", motif: "Isolation par compte testée ; jamais transformée automatiquement depuis un message." },
  { cle: "intelligence.memoire_projet", categorie: "intelligence", libelle: "Mémoire projet", etat: "CONNECTED_AND_TESTED", source: "server/intelligences/memoire-projet.ts (LOT IA02F)", motif: "Append-only, isolée par projet (réutilise chantier/projets.ts::ouvrir)." },
  ...
  { cle: "intelligence.rag", categorie: "intelligence", libelle: "RAG", etat: "CONNECTED_AND_TESTED", source: "server/intelligences/rag.ts (LOT IA02F)", motif: "Retrieval réel (PostgreSQL plein texte, ts_rank) avec citations et statuts SOURCE_NOT_FOUND/INSUFFICIENT_SOURCE_DATA ; méthode lexicale, pas sémantique (voir intelligence.embeddings)." },
  { cle: "intelligence.recherche", categorie: "intelligence", libelle: "Recherche", etat: "CONNECTED_AND_TESTED", source: "server/intelligences/recherche-globale.ts (LOT IA02F), server/search-os (autre domaine)", motif: "Recherche centralisée réelle (conversations, mémoire, fichiers, connaissances), isolée par compte." },
  { cle: "intelligence.embeddings", categorie: "intelligence", libelle: "Embeddings", etat: "NOT_CONNECTED", source: "server/intelligences/rag.ts::embeddingGateway (LOT IA02F)", motif: "Passerelle posée et remplaçable, mais aucun fournisseur d'embeddings connecté à ce jour — repli lexical assumé, jamais présenté comme sémantique." },
  { cle: "intelligence.fichiers", categorie: "intelligence", libelle: "Fichiers", etat: "CONNECTED_AND_TESTED", source: "server/intelligences/fichiers.ts (LOT IA02F)", motif: "Pipeline réel (upload→parse→chunk→index→ready_for_rag) pour PDF/DOCX/XLSX/TXT/CSV/JSON ; images sans OCR (métadonnées seules)." },
  ...
  { cle: "execution.context_windows", categorie: "execution", libelle: "Fenêtre de contexte", etat: "PARTIAL", source: "server/intelligences/service.ts (limit 8 messages, codé en dur) + server/intelligences/conversation-resume.ts (LOT IA02F)", motif: "Fenêtre brute toujours codée en dur ; un résumé + faits importants s'y ajoutent désormais au-delà de 16 messages non couverts." },
  ...
  { cle: "rbac.fournisseur_transporteur", categorie: "plateforme", libelle: "RBAC Fournisseur/Transporteur", etat: "CONNECTED_AND_TESTED", source: "server/supplier-engine/access.ts, server/routers/supplier-portal.ts (LOT 7 suite)", motif: "READY_FOR_ONBOARDING : architecture, isolement par entreprise et permissions réels et testés (17 assertions) ; aucun compte réel de production n'a été ouvert avec ces rôles — un PDG doit accorder explicitement chaque accès." },
];
