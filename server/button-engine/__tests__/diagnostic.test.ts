...
assert.equal(destination.redirection, "bouton_garage_devis");
assert.ok(destination.testsRequis.includes("test du Moteur de Redirection"));
...
console.log("11/11 assertions diagnostic bouton réussies.");
