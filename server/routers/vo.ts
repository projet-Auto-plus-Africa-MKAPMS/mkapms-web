  ...
  updateStatus: protectedProcedure
    .input(z.object({
      ...
      status: z.enum([
        ...
        "diagnostic_en_cours", "diagnostic_termine", "devis_interne", "en_attente_pieces", "en_reparation",
        "reparation_terminee", "controle_final", "preparation_esthetique", "shooting_media",
        "historique_verifie", "pret",
        "en_vente", "annonce_publiee", "reserve", "dossier_admin", "livraison",
        "en_location", "vendu", "loue", "exporte", "stock_interne", "a_revoir", "archive",
      ]),
