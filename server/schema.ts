...
export const paymentTypeEnum = pgEnum("payment_type", ["rental_caution", "society_acompte", "pro_subscription", "franchise_subscription", "vehicle_boost", "vehicle_purchase"]);
...
export const userRoleEnum = pgEnum("user_role", ["user", "pro", "garage", "employee", "society", "admin", "super_admin", "supplier", "carrier"]);
...
export const users = pgTable("users", {
  ...
  companySiren: varchar("company_siren", { length: 16 }),
...
export * from "./document-engine/schema"; // Document Engine — LOT 6 : documents fournisseur/véhicule, chaîne de possession (isolé)
