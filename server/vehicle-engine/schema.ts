 ...
 * la précédente, et MKA.P-MS AI n'a jamais accès en écriture aux
...
export const vehicleItems = pgTable(
  "vehicle_items",
  {
    ...
    /** Suggestions MKA.P-MS AI seules : descriptions, score qualité — jamais une valeur contractuelle. */
